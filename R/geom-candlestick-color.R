...
#' Only affects `geom_candlestick_color`.
#'
#' @section Aesthetics:
...
#'     geom_barchart_color(aes(open = open, high = high, low = low, close = close)) +
...
#' AAPL %>%
#'     ggplot(aes(x = date, y = close)) +
#'     geom_candlestick_color(aes(open = open, high = high, low = low, close = close)) +
#'     geom_ma(color = "darkgreen") +
#'     coord_x_date(xlim = c("2016-01-01", "2016-12-31"),
#'                  ylim = c(75, 125))
...
#' @rdname geom_chart
#' @export
geom_barchart_color <- function(mapping = NULL, data = NULL, stat = "identity",
...
#' @rdname geom_chart
#' @export
geom_candlestick_color <- function(mapping = NULL, data = NULL, stat = "identity",
                             position = "identity", na.rm = TRUE, show.legend = NA,
                             inherit.aes = TRUE,
                             color_up = "darkblue", color_down = "red",
                             fill_up = "darkblue", fill_down = "red",
